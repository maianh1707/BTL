...
namespace BTLLAPTRINH.Forms
{
    public partial class Baocaocuoingay : Form
    {
        ...
        {
            string sql;
            sql = "select a.masanpham, b.tensanpham, a.soluongnhap, a.dongianhap, a.tongtiennhap, a.soluongban, a.dongiaban, a.tongtienban, a.doanhthu from tblchitietbccn as a " + " join tblsanpham as b on a.masanpham = b.masanpham where a.mabaocao= N'" + txtmabaocao.Text + "'";
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            sql = "select masanpham from tblchitietbccn where masanpham=N'" + cbosp.SelectedValue + "'and mabaocao=N'" + txtmabaocao.Text.Trim() + "'";
            if (Class.Function.CheckKey(sql))
            {
            ...
            sql = "insert into tblchitietbccn(mabaocao,masanpham,soluongnhap,dongianhap,tongtiennhap,soluongban,dongiaban,tongtienban,doanhthu)values(N'"+txtmabaocao.Text.Trim()+"',N'"+cbosp.SelectedValue+"','"+txtsoluongnhap.Text+"','"+txtgianhap.Text+"','"+txttongtiennhap.Text+"','"+txtsoluongban.Text+"','"+txtgiaban.Text+"','"+txttongtienban.Text+"','"+txtdoanhthu.Text+"')";
            Class.Function.RunSql(sql);
            Load_ThongtinSanpham();
        ...
        private void btnhuy_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                int n = 0;
                int i;
                sql = "select masanpham from tblchitietbccn where mabaocao= N'" + txtmabaocao.Text + "'";
        ...
        private void btnin_Click(object sender, EventArgs e)
        {
            ...
            sql = "select b.tensanpham, a.soluongnhap,a.dongianhap,a.tongtiennhap, a.soluongban, a.dongiaban,a.tongtienban,a.doanhthu  from tblchitietbccn as a , tblsanpham as b where a.mabaocao = N'" + txtmabaocao.Text + "' and a.masanpham = b.masanpham";
            ...
            sql = "select b.tensanpham, a.soluongnhap, a.dongianhap, a.tongtiennhap, a.soluongban, a.dongiaban, a.tongtienban, a.doanhthu " +
                  "from tblchitietbccn as a, tblsanpham as b " +
